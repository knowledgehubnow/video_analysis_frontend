...
def body_posture(image,fps):
    ...
    l_shldr_x, l_shldr_y, r_shldr_x, r_shldr_y, l_ear_x, l_ear_y, l_hip_x, l_hip_y = 0, 0, 0, 0, 0, 0, 0, 0
    ...
    if keypoints.pose_landmarks:
        ...
        # Handle the case when no landmarks are found, for example, by skipping the frame.
        pass
